...
@ir.signature_to_opcode
def assign(value: Unit | Int, target: Unit) -> None: ...
...
@typing.overload
@ir.signature_to_opcode
def div(dividend: Unit | Int, divisor: Unit | Int, quotient: Unit, remainder: None) -> None: ...
@typing.overload
@ir.signature_to_opcode
def div(dividend: Unit | Int, divisor: Unit | Int, quotient: None, remainder: Unit) -> None: ...
@typing.overload
@ir.signature_to_opcode
def div(dividend: Unit | Int, divisor: Unit | Int, quotient: Unit, remainder: Unit) -> None: ...
@ir.signature_to_opcode
def div(dividend: Unit | Int, divisor: Unit | Int, quotient: Unit | None, remainder: Unit | None) -> None: ...
...
@ir.signature_to_opcode
def mul(multiplicand: Unit | Int, multiplier: Unit | Int, target: Unit) -> None: ...
...
@ir.signature_to_opcode
def or_(left: Unit, right: Unit, target: Unit) -> None: ...


@ir.signature_to_opcode
def sub(minuend: Unit | Int, subtrahend: Unit | Int, target: Unit) -> None: ...


@ir.signature_to_opcode
def xor(left: Unit, right: Unit, target: Unit) -> None: ...
